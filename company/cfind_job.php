...
<div class="flex flex-wrap items-center gap-3 bg-[#161616] p-4 rounded-2xl border border-gray-800">
    ...
    <!-- Clear -->
    <a href="cfind_job.php" class="bg-yellow-400 text-black px-4 h-10 flex items-center justify-center rounded-lg text-sm font-semibold hover:bg-yellow-500 whitespace-nowrap">
        Clear
    </a>
</div>
</form>
